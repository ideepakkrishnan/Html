 ...
 *
 */
public class HTMLFactoryTests extends TestCase {
	
	private AbstractHTMLNodeFactory factory = new StandardHTMLNodeFactory();
     ...
     */
    public HTMLFactoryTests( String testName )
    {
        super( testName );
    }
    ...
    {
        return new TestSuite( HTMLFactoryTests.class );
    }
